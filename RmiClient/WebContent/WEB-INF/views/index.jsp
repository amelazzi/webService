    ...
    <div class="card-body login-card-body">
      ...
      <form action="<c:url value="/login"/>" method="post">
        ...
        <div class="d-flex justify-content-between">
          <p class="mb-0">
	        <a href="<c:url value="/register" />" class="text-center"><fmt:message key="index.signup"/></a>
	      </p>
          <!-- /.col -->
          <div class="col-6">
            <button type="submit" class="btn btn-primary btn-block"><fmt:message key="index.signin"/></button>
          </div>
          <!-- /.col -->
        </div>
      </form>
